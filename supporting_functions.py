...
def create_output_images(Rover):
      ...
      cv2.putText(map_add,"Fidelity: "+str(fidelity)+'%', (0, 40), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"Mode: "+Rover.mode, (0, 55), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"Rocks", (0, 70), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"  Located: "+str(samples_located), (0, 85), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"  Collected: "+str(Rover.samples_collected), (0, 100), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)


      # # # Use these outputs for sample collection debugging
      # # if Rover.pos is not None:
      # #       cv2.putText(map_add,"  Rover Pos: {:.2f}, {:.2f}".format(Rover.pos[0], Rover.pos[1]), (0, 70), 
      # #                   cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      # # if Rover.prev_dest is not None:
      # #       cv2.putText(map_add,"  Rover Prev Pos: {:.2f}, {:.2f}".format(Rover.prev_dest[0], Rover.prev_dest[1]), (0, 85), 
      # #                   cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      # # if (Rover.dest_x is not None) and (Rover.dest_y is not None):
      # #       cv2.putText(map_add,"  Rover Dest: {:.2f}, {:.2f}".format(Rover.dest_x, Rover.dest_y), (0, 100), 
      # #                   cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      # # if Rover.dest_angle is not None:
      # #       cv2.putText(map_add,"  Dest Angle: {:.2f}".format(Rover.dest_angle), (0, 115), 
      # #                   cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      # # if Rover.rock_dist is not None:
      # #       cv2.putText(map_add,"Dist to Rock: {:.2f}".format(np.mean(Rover.rock_dist)), (0, 160), 
      # #                   cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)

      # # Use these outputs for angle and wall detection debugging
      # if Rover.nav_angles is not None:
      #       cv2.putText(map_add,"Len Angles: {}".format(len(Rover.nav_angles)), (0, 70), 
      #                   cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      # if Rover.front_angles is not None:
      #       cv2.putText(map_add,"Angles Ahead: {}".format(len(Rover.front_angles)), (0, 85), 
      #                   cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)      
      # if Rover.front_angles_3deg is not None:
      #       cv2.putText(map_add,"3 Deg Ahead: {} ".format(len(Rover.front_angles_3deg)), (0, 100), 
      #             cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)   
      # # if Rover.front_angles_1deg is not None:
      # #       cv2.putText(map_add,"1 Deg Angles: {}".format(len(Rover.front_angles_1deg)), (0, 115), 
      # #                   cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)             
      # # if Rover.left_angles is not None:
      # #       cv2.putText(map_add,"Left Angles: {}".format(len(Rover.left_angles)), (0, 130), 
      # #                   cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      # # if Rover.right_angles is not None:
      # #       cv2.putText(map_add,"Right Angles: {}".format(len(Rover.right_angles)), (0, 145), 
      # #                   cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      # if Rover.stuck_type is not None:
      #       cv2.putText(map_add,"Stuck Type: {}".format(Rover.stuck_type), (0, 175), 
      #                   cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)

      # cv2.putText(map_add,"t0 {:.2f}".format(Rover.t0), (0, 115), 
      #             cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      # # if Rover.right_angles is not None:
      # cv2.putText(map_add,"Dist Traveled: {:.2f}".format(Rover.dist_traveled), (0, 160), 
      #             cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      # if Rover.prev_yaw is not None:
      #       cv2.putText(map_add,"Prev Yaw: {:.2f}".format(Rover.prev_yaw), (0, 145), 
      #                   cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
