...
class RoverState():
    def __init__(self):
        ...
        self.stuck_time = 2 # Used to help the rover get unstuck, checking if rover is stuck every 2 seconds
        ...
        self.t0 = None # A time tracker to help the rover find new pathways when it's stuck in the same area
        self.travel_dist = 0
        self.pre_steer = 0
        self.valid = None
